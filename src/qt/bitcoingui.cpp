...
{
    resize(850, 550);
    setWindowTitle(tr(COIN_NAME " Wallet"));
#ifndef Q_WS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a " COIN_NAME " address"));
    ...
    aboutAction->setToolTip(tr("Show information about " COIN_NAME));
    ...
    optionsAction->setToolTip(tr("Modify configuration options for " COIN_NAME));
    optionsAction->setMenuRole(QAction::PreferencesRole);

    toggleHideAction = new QAction(QIcon(":/icons/coin"), tr("Show/Hide &" COIN_NAME), this);
    toggleHideAction->setToolTip(tr("Show or hide the " COIN_NAME " window"));
    ...
    connect(unlockWalletAction, SIGNAL(triggered(bool)), this, SLOT(unlockWallet(bool)));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr(COIN_NAME " client"));
    ...
    notificator = new Notificator(tr(COIN_SLUG "-qt"), trayIcon);
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to " COIN_NAME " network", "", count));
}
...
void BitcoinGUI::askFee(qint64 nFeeRequired, bool *payFee)
{
    QString strMessage =
        tr("This transaction is over the size limit.  You can still send it for a fee of %1, "
          "that will be destroyed to help support the network.  "
...
void BitcoinGUI::unlockWallet(bool status)
{
    if (!walletModel)
        return;
