...
void InitMessage(const std::string &message)
{
    if(splashref)
    {
        //splashref->showMessage(QString::fromStdString(message), Qt::AlignBottom|Qt::AlignHCenter, QColor(100, 100, 100));
...
// TODO: implement qtipcserver.cpp for Mac and Windows
    ...
    {
        if (strlen(argv[i]) >= 7 && strncasecmp(argv[i], COIN_SCHEME ":", sizeof(COIN_SCHEME)) == 0)
        {
